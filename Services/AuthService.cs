...
namespace ChatApi.Services
{
    public class AuthService
    {
        ...
        public AuthService(
            IOptions<ChatApiDatabaseSettings> chatApiDatabaseSettings,
            IConfiguration configuration
        )
        {
            var mongoClient = new MongoClient(chatApiDatabaseSettings.Value.ConnectionString);
            var mongoDatabase = mongoClient.GetDatabase(chatApiDatabaseSettings.Value.DatabaseName);

            _usersCollection = mongoDatabase.GetCollection<User>(
                chatApiDatabaseSettings.Value.UsersCollectionName
            );
